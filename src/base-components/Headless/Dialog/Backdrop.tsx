  ...
  return (
    <>
      ...
      <Transition.Child
        ...
        enterTo="opacity-100 mt-28"
        leave="ease-in-out duration-[400ms]"
        leaveFrom="opacity-100 center"
        leaveTo="opacity-0 -mt-36"
      ...
      >
        <HeadlessDialog.Panel
          ...
          className={twMerge([
            ...
            // "w-[30%] mx-auto my-auto relative   transition-transform ",
            dialog.size == "md" && "sm:w-[300px]",
            dialog.size == "sm" && "sm:w-[300px]",
            dialog.size == "lg" && "sm:w-[300px]",
            dialog.size == "xl" && "sm:w-[300px] lg:w-[500px]",
