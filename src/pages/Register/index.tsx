...
function Main() {
  return (
    <>
      <div
        className={clsx([
          "-m-3 sm:-mx-8 p-3 xl:p-0  sm:px-0 relative h-screen lg:overflow-hidden bg-primary xl:bg-white dark:bg-darkmode-800 xl:dark:bg-darkmode-600",
          "after:hidden after:xl:block after:content-[''] after:w-[57%] xl:after:w-0 after:-mt-[20%] after:-mb-[13%] after:-ml-[13%] after:absolute after:inset-y-0 after:left-0 after:transform after:rotate-[-4.5deg] after:bg-primary after:rounded-[100%] after:dark:bg-darkmode-700",
        ])}
      >
        <div className="container relative z-10 ">
          <div className="block grid-cols-2 gap-4 xl:grid">
            ...
            {/* END: Register Info */}
            {/* BEGIN: Register Form */}
            <div className="flex h-screen py-5 my-10 xl:h-auto xl:py-0 xl:my-0 xl:w-1/2">
